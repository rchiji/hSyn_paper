...
# saveRDS(all.markers, "02_Publicdata/RDS/all.markers_20251022.rds")
# saveRDS(all.markers_rename, "02_Publicdata/RDS/all.markers_after_rename_20251022.rds")
...
# saveRDS(all.markers, "02_Publicdata/Stromal/all.markers_Stromal_20251022.rds")
# write.table(all.markers_top10, "02_Publicdata/Stromal/top10.txt", sep = "\t")
# write.table(all.markers_top30, "02_Publicdata/Stromal/top30.txt", sep = "\t")
...
# saveRDS(sc_fib, "02_Publicdata/Stromal/seuratObj_Fibro_20251022.rds")
# saveRDS(sc_fib_2, "02_Publicdata/Stromal/seuratObj_Fibro_remove_doublet_20251022.rds")
...
# saveRDS(all.markers, "02_Publicdata/Myeloid/all.markers_Myeloid_20251022.rds")
# write.table(all.markers_top10, "02_Publicdata/Myeloid/top10.txt", sep = "\t")
# write.table(all.markers_top30, "02_Publicdata/Myeloid/top30.txt", sep = "\t")
...
# saveRDS(all.markers, "02_Publicdata/Myeloid/DC/all.markers_20251022.rds")
# write.table(all.markers_top10, "02_Publicdata/Myeloid/DC/top10.txt", sep = "\t")
# write.table(all.markers_top30, "02_Publicdata/Myeloid/DC/top30.txt", sep = "\t")
...
# saveRDS(all.markers, "02_Publicdata/Myeloid/DC/all.markers_update_20251022.rds")
# write.table(all.markers_top10, "02_Publicdata/Myeloid/DC/top10_update.txt", sep = "\t")
# write.table(all.markers_top30, "02_Publicdata/Myeloid/DC/top30_update.txt", sep = "\t")
...
# saveRDS(all.markers, "02_Publicdata/Myeloid/Macrophage/all.markers_20251022.rds")
# write.table(all.markers_top10, "02_Publicdata/Myeloid/Macrophage/top10.txt", sep = "\t")
# write.table(all.markers_top30, "02_Publicdata/Myeloid/Macrophage/top30.txt", sep = "\t")
...
# saveRDS(all.markers, "02_Publicdata/Myeloid/Macrophage/all.markers_update_20251022.rds")
# write.table(all.markers_top10, "02_Publicdata/Myeloid/Macrophage/top10_update.txt", sep = "\t")
# write.table(all.markers_top30, "02_Publicdata/Myeloid/Macrophage/top30_update.txt", sep = "\t")
...
# saveRDS(sc_MonoMacroDC, "02_Publicdata/Myeloid/seuratObj_Myeloid_20251022.rds")
# saveRDS(sc_MonoMacroDC_2, "02_Publicdata/Myeloid/seuratObj_Myeloid_remove_doublet_20251022.rds")
# saveRDS(sc_DC, "02_Publicdata/Myeloid/seuratObj_Myeloid_DC_20251022.rds")
# saveRDS(sc_Mac, "02_Publicdata/Myeloid/seuratObj_Myeloid_Macrophage_20251022.rds")
# saveRDS(sc_gra, "02_Publicdata/Myeloid/seuratObj_Myeloid_granulocyte_20251022.rds")
...
# saveRDS(all.markers, "02_Publicdata/Lymphoid/T_NK/all.markers_T_NK_20251022.rds")
# write.table(all.markers_top10, "02_Publicdata/Lymphoid/T_NK/top10.txt", sep = "\t")
# write.table(all.markers_top30, "02_Publicdata/Lymphoid/T_NK/top30.txt", sep = "\t")
...
# saveRDS(all.markers, "02_Publicdata/Lymphoid/T_NK/NK/all.markers_20251022.rds")
# write.table(all.markers_top10, "02_Publicdata/Lymphoid/T_NK/NK/top10.txt", sep = "\t")
# write.table(all.markers_top30, "02_Publicdata/Lymphoid/T_NK/NK/top30.txt", sep = "\t")
...
# saveRDS(all.markers, "02_Publicdata/Lymphoid/T_NK/T/all.markers_20251022.rds")
# write.table(all.markers_top10, "02_Publicdata/Lymphoid/T_NK/T/top10.txt", sep = "\t")
# write.table(all.markers_top30, "02_Publicdata/Lymphoid/T_NK/T/top30.txt", sep = "\t")
...
# saveRDS(sc_lymphoid, "02_Publicdata/Lymphoid/seuratObj_Lymphoid_20251022.rds")
# saveRDS(sc_T_NK, "02_Publicdata/Lymphoid/seuratObj_T_NK_20251022.rds")
# saveRDS(sc_NK, "02_Publicdata/Lymphoid/NK/seuratObj_NK_20251022.rds")
# saveRDS(sc_T, "02_Publicdata/Lymphoid/T/seuratObj_Tcell_20251022_latest.rds")
...
# saveRDS(all.markers, "02_Publicdata/Endothelial/all.markers_endothelial_remove_doublet_20251022.rds")
# write.table(all.markers_top10, "02_Publicdata/Endothelial/top10.txt", sep = "\t")
# write.table(all.markers_top30, "02_Publicdata/Endothelial/top30.txt", sep = "\t")
...
# saveRDS(all.markers, "02_Publicdata/Endothelial/all.markers_endothelial_remove_doublet_update_20251022.rds")
# write.table(all.markers_top10, "02_Publicdata/Endothelial/top10_update.txt", sep = "\t")
# write.table(all.markers_top30, "02_Publicdata/Endothelial/top30_update.txt", sep = "\t")
...
# saveRDS(sc_ec_2, "02_Publicdata/Endothelial/seuratObj_endothelial_remove_doublet_20251022.rds")
...
# saveRDS(all.markers, "02_Publicdata/Mural/all.markers_mural_remove_doublet_20251022.rds")
# write.table(all.markers_top10, "02_Publicdata/Mural/top10.txt", sep = "\t")
# write.table(all.markers_top30, "02_Publicdata/Mural/top30.txt", sep = "\t")
...
# saveRDS(sc_mural_2, "02_Publicdata/Mural/seuratObj_mural_remove_doublet_20251022.rds")
...
# ggsave("02_Publicdata/Res/All/after/Dim_Class_comparison_nonDoublet.png", plot = p_UMAP, height = 1.5, width = 9)
# ggsave("02_Publicdata/Res/All/after/Dim_Class_comparison_nonDoublet.pdf", plot = p_UMAP, height = 1.5, width = 9)
...
#   )
# ggsave("02_Publicdata/Res/All/after/Stacked_Class1_nonDoublet.png", p_stacked_bar_class1, height = 1.5, width = 2.5)
# ggsave("02_Publicdata/Res/All/after/Stacked_Class1_nonDoublet.pdf", p_stacked_bar_class1, height = 1.5, width = 2.5)
# 
...
#     plot.margin = margin(0.2, 0.2, 0.2, 0.2, "mm")
#   )
# ggsave("02_Publicdata/Res/All/after/Stacked_Class2_nonDoublet.png", p_stacked_bar_class2, height = 1.5, width = 2.8)
# ggsave("02_Publicdata/Res/All/after/Stacked_Class2_nonDoublet.pdf", p_stacked_bar_class2, height = 1.5, width = 2.8)
# 
...
#     plot.margin = margin(0.2, 0.2, 0.2, 0.2, "mm")
#   )
# ggsave("02_Publicdata/Res/All/after/Stacked_Class3_nonDoublet.png", p_stacked_bar_class3, height = 1.5, width = 5.55)
# ggsave("02_Publicdata/Res/All/after/Stacked_Class3_nonDoublet.pdf", p_stacked_bar_class3, height = 1.5, width = 5.55)
