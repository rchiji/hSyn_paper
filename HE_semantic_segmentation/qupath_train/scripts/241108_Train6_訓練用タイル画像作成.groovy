...
// タイル中に含まれるアノテーション領域の割合。labelAreaRatioより少ないアノテーション面積であればそのタイル画像はかき出さない。
double labelAreaRatio = 5
int tileSize = 512  // タイルの辺の長さ px
int tileOverlap = 256  // タイルの重複幅 px
def imageExtension = ".jpg"
def pathOutput = "C:/Users/admin/Documents/東京大学 整形外科/ヒト滑膜/hSyn_QuPath3//Train6_241108"
// --------------------------------
