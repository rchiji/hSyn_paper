...
// modelへのパス
String modelPath = "C:\\Users\\admin\\Documents\\東京大学 整形外科\\ヒト滑膜\\hSyn_QuPath3\\model6_241108.h5"
...
// 予測後ラベル画像の保存場所
def label_dir = new File(buildFilePath(PROJECT_BASE_DIR, "wsi_labels", slideName))
