...
"""
convolution_block
- A single block consisting of Conv2D -> BatchNorm or Conv2D -> BatchNorm -> Activation
- relu: specifies whether to apply an activation function at the end
"""
## Modified conv_block so that it can switch between Conv2D -> BatchNorm and Conv2D -> BatchNorm -> ReLU
## Also modified it so that the case with strides=2 can be selected
